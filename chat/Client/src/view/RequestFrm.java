...
public class RequestFrm extends javax.swing.JDialog {
    ...
    private void acceptBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_acceptBtnActionPerformed
        if (selectedIndex != -1) {
            ...
            mySocket.sendData(new ObjectWrapper(ObjectWrapper.CONFIRM_FRIEND, friendId));
        }
    ...
    public void receivedDataProcessing(ObjectWrapper data) {
        ...
        if (data.getPerformative() == 14) {
            this.requests = (ArrayList<RequestDTO>) data.getData();
            mapToTable();
        }
//        reply confirm
        if (data.getPerformative() == 8) {
            ...
            if (mess.equals("ok")) {
                ...
                JOptionPane.showMessageDialog(rootPane, "Error in accepting");
