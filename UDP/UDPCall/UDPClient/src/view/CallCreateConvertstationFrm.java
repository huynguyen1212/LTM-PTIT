...
public class CallCreateConvertstationFrm extends javax.swing.JDialog {
    private ClientCtr mySocket;
    private User user;
    Frame parent;
    private ArrayList<User> listFriend = new ArrayList<>();

    public CallCreateConvertstationFrm(java.awt.Frame parent, boolean modal, ClientCtr mySocket, User user) {
        super(parent, modal);
        initComponents();
        this.parent = parent;
...
//        System.out.println(listFriendData.size() + "> xxx");
        mapListFriend();
    }
    ...
    void mapListFriend() {
        ...
        for (User user1 : listFriend) {
            String status = user1.getOnline() == 1 ? "ON" : "OFF";
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (listPicked.length >= 1) {
            ...
            mySocket.sendData(new ObjectWrapper(ObjectWrapper.CALL_CREATE_CONVERSTATION, listU));
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CallCreateConvertstationFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                CallCreateConvertstationFrm dialog = new CallCreateConvertstationFrm(new javax.swing.JFrame(), true, null, null);
