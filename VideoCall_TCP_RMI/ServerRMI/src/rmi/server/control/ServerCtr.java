...
import jdbc.dao.GroupMemberDAO;
import jdbc.dao.GroupMemberDAO2;
...
//        throw new UnsupportedOperationException("Not suppor/ted yet."); //To change body of generated methods, choose Tools | Templates.
    ...
    public ArrayList<Group> getListGroups(int userId) throws RemoteException {
        return new GroupMemberDAO().getListGroups(userId);
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
...
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    ...
    @Override
    public boolean leaveGroup(int group, int userId) throws RemoteException {
        return new GroupMemberDAO().leaveGroup(group, userId);
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public boolean deleteGroup(int id) throws RemoteException {
        return new GroupDAO().deleteGroup(id);
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public ArrayList<User> getListUserInGroup(int groupId) throws RemoteException {
        return new GroupMemberDAO().getListMemberInGroup(groupId);
//        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
    }
...
//    @Override
//    public ArrayList<Group> searchGroupByName(String key) throws RemoteException {
//        return new GroupDAO().searchGroup(key);
////        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
//    }
//
//    @Override
//    public boolean joinGroup(Integer userId, int groupId) throws RemoteException {
//        return new GroupMemberDAO2().joinGroup(userId,groupId);
////        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
//    }
//
//    @Override
//    public boolean acceptGroupRequest(Integer memberId) throws RemoteException {
//        return new GroupMemberDAO2().acceptMember(memberId);
////        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
//    }
//
//    @Override
//    public boolean refuseGroupRequest(Integer memberId) throws RemoteException {
//        return new GroupMemberDAO2().refuseMember(memberId);
////        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
//    }
//
//    @Override
//    public boolean addMemberToGroup(Integer userId, int groupId) throws RemoteException {
//        return new GroupMemberDAO2().addMember(userId,groupId);
////        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
//    }
//
//    @Override
//    public ArrayList<GroupMember> getListRequestJoin(int groupId) throws RemoteException {
//        return new GroupMemberDAO2().getListRequestJoin(groupId);
////        throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
//    }
