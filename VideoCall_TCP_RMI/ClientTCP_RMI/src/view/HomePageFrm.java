...
//    private JTextField txtId, txtName, txtIdcard, txtAddress, txtEmail, txtTel, txtNote;
    private JButton btnListFriends, btnListGroups, btnListRequests, btnSearchUser;
    ...
    public HomePageFrm(ClientCtr socket) {
        ...
        btnSearchUser.setBounds(210, 233, 206, 33);
        ...
        btnListGroups = new JButton("List group");
        btnListGroups.setBounds(210, 294, 206, 33);
...
//        mySocket.getActiveFunction().add(new ObjectWrapper(ObjectWrapper.INCOMING_CALL, this)); 
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (btnClicked.equals(btnListFriends)) {
            ...
            (new ListGroupFrm2(mySocket)).setVisible(true);
            mySocket.sendData(new ObjectWrapper(ObjectWrapper.LIST_GROUPS, null));
        }
    }
