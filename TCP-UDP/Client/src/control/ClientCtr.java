                            ...
                            for (ObjectWrapper fto : myFunction) {
                                if (fto.getPerformative() == data.getPerformative()) {
                                    switch (data.getPerformative()) {
                                        case ObjectWrapper.INCOMING_CALL:
                                            HomePageFrm icv = (HomePageFrm) fto.getData();
                                            PrivateCall privateCall = (PrivateCall) data.getData();
                                            System.out.println("co cuoc goi moi:" + privateCall.getSourceId());
                                            icv.receivedDataProcessing(data);
                                            break;
