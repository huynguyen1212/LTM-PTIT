 ...
 */
public class CreateUserFrm extends JFrame implements ActionListener {
    ...
    public CreateUserFrm(ClientCtr socket) {
        super("");
        mySocket = socket;
        ...
        btnCreate.setBounds(267, 350, 136, 31);
        ...
        mySocket.getActiveFunction().add(new ObjectWrapper(ObjectWrapper.REPLY_CREATE_USER, this));
