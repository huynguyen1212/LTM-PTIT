...
public class ObjectWrapper implements Serializable {
    ...
    public static final int CREATE_USER = 50;
    public static final int REPLY_CREATE_USER = 51;
    public static final int CREATE_BOOK = 52;
    public static final int REPLY_CREATE_BOOK = 53;
    public static final int CREATE_READER = 54;
    public static final int REPLY_CREATE_READER = 55;
