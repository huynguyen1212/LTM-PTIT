 ...
 * @author sonht
 */
public class UpdateCustomerFrm extends javax.swing.JDialog {
    ...
    public UpdateCustomerFrm(java.awt.Frame parent, boolean modal, Customer customer) {
        super(parent, modal);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        customer.setName(updateClientNameTxt.getText());
        customer.setAddress(updateClientAddressTxt.getText());
        customer.setIdCard(updateClientIdCardTxt.getText());
        customer.setEmail(updateClientEmailTxt.getText());
        customer.setTel(updateClientTelTxt.getText());
        customer.setNote(updateClientNoteTxt.getText());
        boolean res = cd.editCustomer(customer);
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        boolean res = cd.deleteCustomer(id);
    ...
    void initial() {
        updateClientNameTxt.setText(customer.getName());
        updateClientTelTxt.setText(customer.getTel());
        updateClientEmailTxt.setText(customer.getEmail());
        updateClientNoteTxt.setText(customer.getNote());
        updateClientAddressTxt.setText(customer.getAddress());
        updateClientIdCardTxt.setText(customer.getIdCard());
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UpdateCustomerFrm.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                UpdateCustomerFrm dialog = new UpdateCustomerFrm(new javax.swing.JFrame(), true, null);
