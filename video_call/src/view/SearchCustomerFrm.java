...
public class SearchCustomerFrm extends javax.swing.JFrame {
    ...
    private void searchClientBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchClientBtnActionPerformed
        ...
        customers = (new CustomerDAO()).searchCustomer(clientName);
        String[] columns = {"ID", "Tên", "ID Card", "Địa chỉ", "Email", "SĐT", "Ghi chú"};
        String[][] values = new String[customers.size()][columns.length];
        for (int i = 0; i < customers.size(); i++) {
            values[i][0] = customers.get(i).getId() + "";
            values[i][1] = customers.get(i).getName() + "";
            values[i][2] = customers.get(i).getIdCard() + "";
            values[i][3] = customers.get(i).getAddress() + "";
            values[i][4] = customers.get(i).getEmail() + "";
            values[i][5] = customers.get(i).getTel() + "";
            values[i][6] = customers.get(i).getNote() + "";
        }
    ...
    private void clientTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_clientTableMouseClicked
        ...
        (new UpdateCustomerFrm(this, rootPaneCheckingEnabled, customers.get(index))).setVisible(true);
    }//GEN-LAST:event_clientTableMouseClicked

    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        (new AddCustomerFrm(this, rootPaneCheckingEnabled)).setVisible(true);
