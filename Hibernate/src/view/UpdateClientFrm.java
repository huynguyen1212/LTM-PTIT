...
public class UpdateClientFrm extends javax.swing.JDialog {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        client.setName(updateClientNameTxt.getText());
        client.setAddress(updateClientAddressTxt.getText());
        client.setIdCard(updateClientIdCardTxt.getText());
        client.setEmail(updateClientEmailTxt.getText());
        client.setTel(updateClientTelTxt.getText());
        client.setNote(updateClientNoteTxt.getText());
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        int id = client.getId();
        boolean res = clientDao.deleteClient(id);
